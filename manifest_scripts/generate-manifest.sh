...
manifests_url="https://raw.githubusercontent.com/roms-experimental/android_vendor_waydroid/nad-11/manifest_scripts/manifests"
...
if [ -d "${manifests_path}" ]; then
    ...
    wget "${manifests_url}/03-lineage.xml" -O "${loc_man}/03-lineage.xml"
fi
